...
impl ServerCertVerifier for WebPkiVerifier {
    ...
    fn verify_tls12_signature(
        ...
        Self::default_verify_tls12_signature(message, cert, dss, &self.supported)
    }
    ...
    fn verify_tls13_signature(
        ...
        Self::default_verify_tls13_signature(message, cert, dss, &self.supported)
    }
...
impl WebPkiVerifier {
    ...
    pub fn default_verify_tls12_signature(
        ...
        verify_signed_struct(message, cert, dss, supported_schemes)
    }
    ...
    pub fn default_verify_tls13_signature(
        ...
        verify_tls13(message, cert, dss, supported_schemes)
    }
}
...
impl ClientCertVerifier for AllowAnyAuthenticatedClient {
    ...
    fn verify_tls12_signature(
        ...
        WebPkiVerifier::default_verify_tls12_signature(message, cert, dss, &self.supported)
    }
    ...
    fn verify_tls13_signature(
        ...
        WebPkiVerifier::default_verify_tls13_signature(message, cert, dss, &self.supported)
    }
